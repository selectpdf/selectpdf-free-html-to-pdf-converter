<%@ Page Title="" Language="C#" MasterPageFile="~/Samples.Master" AutoEventWireup="true" CodeBehind="html-to-pdf-headers-and-footers.aspx.cs" Inherits="SelectPdf.Samples.html_to_pdf_headers_and_footers" ValidateRequest="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Select.Pdf Free Html To Pdf Converter for .NET C# - Pdf Headers and Footers with Html to Pdf Converter</title>
    <meta name="description" content="Select.Pdf Pdf Headers and Footers with Html to Pdf Converter Sample for C#. Pdf Library for .NET with full sample code in C# and VB.NET." itemprop="description">
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
        <article class="post type-post status-publish format-standard hentry">
            <header class="entry-header">
                <h1 class="entry-title">Select.Pdf Free Html To Pdf Converter for .NET C# - Pdf Headers and Footers with Html to Pdf Converter</h1>
            </header>
            <!-- .entry-header -->

            <div class="entry-content">
                <p>
                    This sample shows how to convert an url to pdf using Select.Pdf Pdf Library for .NET and how to set html headers and footers for the generated pdf document. 
                    <br />
                    <br />
