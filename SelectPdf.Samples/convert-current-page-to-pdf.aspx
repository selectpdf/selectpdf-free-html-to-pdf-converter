<%@ Page Title="" Language="C#" MasterPageFile="~/Samples.Master" AutoEventWireup="true" CodeBehind="convert-current-page-to-pdf.aspx.cs" Inherits="SelectPdf.Samples.convert_current_page_to_pdf" ValidateRequest="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Select.Pdf Free Html To Pdf Converter for .NET C# - Convert Current Asp.Net Page to Pdf</title>
    <meta name="description" content="Select.Pdf Convert Current Asp.Net Page to Pdf Sample for C#. Pdf Library for .NET with full sample code in C# and VB.NET." itemprop="description">
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
        <article class="post type-post status-publish format-standard hentry">
            <header class="entry-header">
                <h1 class="entry-title">Select.Pdf Free Html To Pdf Converter for .NET C# - Convert Current Asp.Net Page to Pdf</h1>
            </header>
            <!-- .entry-header -->

            <div class="entry-content">
                <p>
                    This sample shows how to use Select.Pdf html to pdf converter to convert the current asp.net page to pdf preserving the values entered in the page controls before hitting the Convert button.
                </p>
                <p>
